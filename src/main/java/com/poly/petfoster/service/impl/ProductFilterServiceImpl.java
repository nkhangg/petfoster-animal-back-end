...
public class ProductFilterServiceImpl implements ProductFilterService {
    ...
    @Override
    public ApiResponse filterProducts(Optional<String> typeName, Optional<Double> minPrice, Optional<Double> maxPrice, Optional<Boolean> stock, Optional<String> brand, Optional<Integer> page) {

        List<ProductItem> productItems = new ArrayList<>();
        List<Product> filterProducts =  productRepository.filterProducts(typeName.orElse(null), minPrice.orElse(null), maxPrice.orElse(null), stock.orElse(null), brand.orElse(null));
